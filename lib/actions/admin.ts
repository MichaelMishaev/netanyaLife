  ...
  try {
    ...
    await prisma.business.create({
      data: {
        ...
        email: pending.email,
        instagram_url: pending.instagram_url,
        facebook_url: pending.facebook_url,
        tiktok_url: pending.tiktok_url,
  ...
  try {
    ...
    await prisma.business.update({
      ...
      data: {
        ...
        instagram_url: pendingEdit.instagram_url,
        facebook_url: pendingEdit.facebook_url,
        tiktok_url: pendingEdit.tiktok_url,
